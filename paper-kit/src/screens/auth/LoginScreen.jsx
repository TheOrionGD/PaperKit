/* LoginScreen — clean auth screen matching PaperKit visual language */
  ...
  return (
    <div className="auth-screen">
      ...
      <div className="auth-screen__card">
        ...
        <p className="auth-screen__subtitle">Sign in to your account</p>
        ...
        <form onSubmit={handleSubmit} className="auth-screen__form">
          <div className="auth-screen__field">
            <label className="auth-screen__label" htmlFor="login-email">Email</label>
          ...
          <div className="auth-screen__field">
            <label className="auth-screen__label" htmlFor="login-password">Password</label>
            <div className="auth-screen__input-wrap">
              ...
              <button
                type="button"
                className="auth-screen__pass-toggle"
          ...
          <PrimaryButton type="submit" loading={loading} id="login-submit-btn">
            Sign In
          </PrimaryButton>
        </form>
        ...
        <button className="auth-screen__google-btn" onClick={handleGoogleLogin} id="login-google-btn">
        ...
        <p className="auth-screen__switch">
          ...
          <button className="auth-screen__switch-link" onClick={() => navigate('/register')} id="login-register-link">
            Sign up
          </button>
        </p>
      </div>
